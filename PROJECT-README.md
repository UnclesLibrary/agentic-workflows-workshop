...
1. **Review the materials**  
   Start with [README.md](README.md) for a complete overview of all materials

2. **Customize for your event**  
   Edit [gh-agentic-workflows-session.md](gh-agentic-workflows-session.md) with your event details
...
1. **Study the facilitator guide**  
   [facilitator-guide.md](facilitator-guide.md) has minute-by-minute instructions
...
5. **Review the slide deck**  
   Build your presentation using [slide-deck-outline.md](slide-deck-outline.md)

### For Participants

1. **Review prerequisites**  
   Check [participant-handout.md](participant-handout.md) for required setup
...
4. **Print the quick reference**  
   [quick-reference-card.md](quick-reference-card.md) for easy access during workshop
...
| ------------------------------------------------------------------ | ----------------------------------------------- | ------------------------- |
| [README.md](README.md)                                             | Materials overview and index                    | Organizers & Facilitators |
| [gh-agentic-workflows-session.md](gh-agentic-workflows-session.md) | Event page description, learning outcomes       | Event Organizers          |
| [facilitator-guide.md](facilitator-guide.md)                       | Complete workshop delivery guide (9,000+ words) | Facilitators              |
| [participant-handout.md](participant-handout.md)                   | Student reference with all commands             | Participants              |
| [example-workflow-prompts.md](example-workflow-prompts.md)         | 28+ tested workflow patterns                    | Everyone                  |
| [slide-deck-outline.md](slide-deck-outline.md)                     | 15-slide presentation structure                 | Facilitators              |
| [quick-reference-card.md](quick-reference-card.md)                 | One-page printable cheat sheet                  | Participants              |
...
1. **Read the [README.md](README.md)** - Understand what's included
2. **Review [facilitator-guide.md](facilitator-guide.md)** - Learn the flow
