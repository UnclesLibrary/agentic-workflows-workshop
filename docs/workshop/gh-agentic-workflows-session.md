...
**What You'll Build:**
Using the multi-language CopilotAdventures repository, you'll create real workflows that:
...
- CopilotAdventures Repository: https://github.com/microsoft/CopilotAdventures
